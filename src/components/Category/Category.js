                    ...
                    {props.categories.map(category => 
                        <tr key={category.CategoryId}>
                            ...
                            <td className="align-middle">
                                <img src={props.url + category.Image  + '?n=' + new Date().getTime()} onError={(e)=>{e.target.src=props.url + 'images/console/sample-product.svg'}} alt={category.Name} width="64" height="64"/>
                            </td>
                            <td className="align-middle">
        ...
        props.categories.map(category => 
            <div key={category.CategoryId} className="col-lg-3 col-sm-6 mb-3">
                <div className="card">
                    ...
                    <img src={props.url + category.Image  + '?n=' + new Date().getTime()} onError={(e)=>{e.target.src=props.url + 'images/console/sample-product.svg'}} className="card-img-top" alt={category.Name} />
