...
class MachineProductBoostView extends Component {
    ...
    fillSingleFeeder = machineProduct => {
        if(machineProduct.Quantity !== machineProduct.MaxItemCount) {
            ...
            axios.put(this.props.url + 'api/machine-product/' + machineProduct.MachineProductId, newMachineProduct, {
                headers: {
                    Authorization: 'Bearer ' + this.props.token
                }
            })
        ...
        return (
            <Fragment>
                ...
                <div className="row mb-2">
                    <div className="col">
                        <button onClick={this.fillAllFeeders} className="btn btn-success btn-lg btn-block">
                            <i className="fas fa-arrow-up"></i>
                        </button>
                    </div>
                    <div className="col">
                        <button onClick={this.emptyAllFeeders} className="btn btn-danger btn-lg btn-block">
                            <i className="fas fa-arrow-down"></i>
                        </button>
                    </div>
                    <div className="col">
                        {machineType === 'LOCKER' ? <button onClick={this.openAll} className="btn btn-secondary btn-lg btn-block">
                            Otwórz
                        </button> : null}
                    </div>
                </div>
