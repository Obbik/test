...
export default ({ machineId }) => {
    ...
    useEffect(() => {
        console.log('useEffect machineProductsData', machineProductsData);
    });
    ...
    const getMachineProducts = () => {
        console.log('getMachineProducts setMachineProductsData');
    ...
    const handleChange = id => evt => {
        console.log('handleChange setMachineProductsData');
    ...
    const handleAddFeeder = () => {
        console.log('handleAddFeeder setMachineProductsData');
    ...
    const handleRemoveNewFeeder = id => () => {
        console.log('handleRemoveNewFeeder setMachineProductsData');
        setMachineProductsData(prev =>
    ...
    const handleToggleOldFeeder = id => () => {
        console.log('handleToggleOldFeeder setMachineProductsData');
        setMachineProductsData(prev =>
        prev.map(machineProduct =>
    ...
    const addFeeder = feeder => {
        console.log('addFeeder setMachineProductsData');
        fetchMssqlApi(
    ...
    const modifyFeeder = feeder => {
        console.log('modifyFeeder setMachineProductsData');
        console.log(initialMachineProducts);
        fetchMssqlApi(
    ...
    const deleteFeeder = feeder => {
        console.log('deleteFeeder setMachineProductsData');
        fetchMssqlApi(
        `machine/${machineId}/products/${feeder.feederNo}`,
        { method: 'DELETE' },
        () => {
    ...
    const submitChanges = () => {
        ...
        !machineProductsData.every(machineProduct => {
            // console.log('machineProduct', machineProduct);
        ...
        <div className="card-body overflow-auto" style={{ maxHeight: 550 }}>
            ...
            <tbody>
                ...
                .map((machineProduct, idx) => (
                    ...
                    <td>
                        {/* <input name="ProductName" value={machineProduct.ProductName} onChange={handleChange(machineProduct.id)}/> */}
                        <DatalistInput
                        name="ProductName"
                        value={machineProduct.ProductName}
                        handleChange={handleChange(machineProduct.id)}
